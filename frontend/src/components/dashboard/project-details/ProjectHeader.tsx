          ...
          <div className="flex flex-wrap items-center gap-2">
            ...
            {showTelegramInvite && onSendTelegramInvite ? (
              <button
                ...
                className="inline-flex items-center gap-1.5 rounded-xl border border-cyan-200 bg-cyan-50 px-3 py-2 text-xs font-semibold text-cyan-800 transition hover:bg-cyan-100 disabled:cursor-not-allowed disabled:opacity-60"
              >
