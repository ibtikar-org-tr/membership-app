...
Small React Native client for the membership API: login, home summary, and events.
...
- Emulator / simulator on the same machine: `http://127.0.0.1:8787/ms/membership-app/api`
- Physical device: `http://<your-lan-ip>:8787/ms/membership-app/api` (not `localhost`)
