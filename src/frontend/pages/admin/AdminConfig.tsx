        ...
        <div className="space-y-4">
          ...
          <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-3">
            ...
            <p className="text-xs text-yellow-700">
              This column will be used to track processed form responses to prevent duplicate emails. 
              The system will automatically mark entries as "processed" or "duplicate" in this column.
            </p>
          </div>
